                  ...
                  <tbody">
                   ...
                   ?>
                     <tr class="fila">
                      ...
                      <td class="text-left"><?php echo $data->montoTotal ?></td>
...
<div class="modal fade mx-auto" id="detalles" data-bs-backdrop="static" data-bs-keyboard="false"  tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog modal-dialog-centered  modal-xl">
    <div class="modal-content w-500">
      ...
      <div class="modal-body">
      <div class="table-responsive bordered ">
        <h2 class="fw-bold" style="color: #c79b2d!important;">Venta N°</h2>
               <table class="table table-hover" id="dataTable">
                <thead class=" card-header text-center" style="color: #fff;">
                  ...
                  <tbody">
                     ...
                     <tr class="fila">
                      <th class="text-center">0987778</th>
                      <th class="text-center">Queen Queen</th>
